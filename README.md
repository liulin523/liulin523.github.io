...
- [Update their own "people" profile](#how-to-update-or-add-a-team-profile)
- [Update the list of publications](#how-to-update-the-publication-list)
- [Update the research page](#how-to-update-the-research-page)
- [Add news posts](#how-to-add-news-items)
...
[hyperlinks](http://www.cuhk.edu.hk) (put the linked text in square brackets 
immediately followed by the address in parens, like: 
`[hyperlinks](http://www.cuhk.edu.hk)`). See 
